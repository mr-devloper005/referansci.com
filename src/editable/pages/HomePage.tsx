...
import { primaryVisibleTask } from '@/editable/content/global.content'
...
export default async function HomePage() {
  // First enabled non-hidden task — profile is hidden by rule, so this
  // always resolves to sbm on this site.
  const primaryTask = primaryVisibleTask() as TaskKey
  ...
  return (
    <EditableSiteShell>
      <main>
        ...
        <div className="mx-auto mt-16 w-full max-w-[var(--editable-container-wide)] px-5 sm:px-6 lg:px-10">
